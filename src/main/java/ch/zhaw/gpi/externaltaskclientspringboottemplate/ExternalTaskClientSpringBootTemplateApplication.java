package ch.zhaw.gpi.externaltaskclientspringboottemplate;
...
@ComponentScan
public class ExternalTaskClientSpringBootTemplateApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ExternalTaskClientSpringBootTemplateApplication.class, args);
    }
}
